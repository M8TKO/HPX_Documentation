...
{
    {
        ...
        for (int i = 0; i < t; ++i)
        {
            // https://hpx-docs.stellar-group.org/tags/v1.10.0/html/libs/core/async_base/api/dataflow.html
            // https://hpx-doc shared_future<double> interests.stellar-group.org/latest/html/libs/core/pack_traversal/api/unwrap.html
